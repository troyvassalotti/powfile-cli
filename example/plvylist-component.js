...
class Plvylist extends HTMLElement {
    constructor() {
        ...
        this.tracks = [
            {
                file: this.getAttribute("audio-location") + "dont-start.mp3" || '',
                title: "Don't Start" || '',
                artist: this.getAttribute("artist-name") || '',
                album: this.getAttribute("album-name")  || '',
                artwork: "tth-min.jpg"  || this.getAttribute("placeholder-image")
            },
            {
                file: this.getAttribute("audio-location") + "on-impulse.mp3" || '',
                title: "On Impulse" || '',
                artist: this.getAttribute("artist-name") || '',
                album: this.getAttribute("album-name")  || '',
                artwork: "tth-min.jpg"  || this.getAttribute("placeholder-image")
            ...
            {
                file: this.getAttribute("audio-location") + "track-title.mp3" || '',
                title: "Track Title" || '',
                artist: this.getAttribute("artist-name") || '',
                album: this.getAttribute("album-name")  || '',
                artwork: "tth-min.jpg"  || this.getAttribute("placeholder-image")
            ...
            {
                file: this.getAttribute("audio-location") + "new_song.mp3" || '',
                title: "New Song" || '',
                artist: this.getAttribute("artist-name") || '',
                album: this.getAttribute("album-name")  || '',
